...
public:
  ...
  bool GetFRequestReplyFlag () const { return FRequestReply; }
  void SetFRequestReplyFlag (bool f) { FRequestReply = f; }
  ...
  void SetMaliciousEnable (bool f) { IsMalicious = f; }                         // Method declared for Blackhole Attack Simulation
  bool GetMaliciousEnable () const { return IsMalicious; }                      // Method declared for Blackhole Attack Simulation
...
private:
  ...
  bool FRequestReply;                  /// Indicates that the RREP packet coming is from a FRREQ packet
...
private:
  ...
  */
  ...
  /// Receive Fake RREQ
  void RecvFRequest (Ptr<Packet> p, Ipv4Address receiver, Ipv4Address src);
  ...
  ///When we receive a reply from a fake RREQ we generate a RERR packet and send it to the precursors list
  void SendRerrWhenBlackHoleAttack (Ptr<Packet> p, Ipv4Address receiver, Ipv4Address sender);
  ...
  /// Send Fake RREQ
  void SendFRequest (RrepHeader const & rrepHeader, RoutingTableEntry const & toOrigin);

  /// Send RREP
  void SendReply (RreqHeader const & rreqHeader, RoutingTableEntry const & toOrigin);


   /// Send RREP from a fake RREQ
   void SendFReqReply (FRreqHeader const & freqHeader, RoutingTableEntry const & toOrigin);
    ...
    */
  void SendReplyByIntermediateNode (RoutingTableEntry & toDst, RoutingTableEntry & toOrigin, bool gratRep, bool fakeReq);
  /// Send RREP_ACK
